...
Use the profile button to select User 1 or User 2 before beginning a measurement; readings are stored against whichever profile is active at the time of measurement.
...
|---|---|---|
| E1 | Cuff not connected or
leak detected | Aborts measurement, displays E1 |
| E2 | Motion artifact detected
during measurement | Aborts measurement, displays
E2, prompts retry |
| E3 | Overpressure condition | Auto-deflates within 2 seconds,
displays E3 |
| E4 | Low battery during
measurement | Aborts measurement, displays E4 |
| E5 | Internal sensor fault | Device disables measurement
